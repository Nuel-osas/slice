...
4. Mirrl computes the exact buys and sells to reach your weights and links each one, prefilled, on CoW Swap and Aerodrome. You sign in your own wallet. Nothing is custodied, nothing is executed by Slice.
...
Coinbase tokenized stocks are offered under Regulation S in eligible jurisdictions outside the United States. Mirrl is a planning tool; it does not offer, sell or execute anything.
